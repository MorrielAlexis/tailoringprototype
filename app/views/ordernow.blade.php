...
@section('content')
                  ...
                  <div class="card-content" style="border:1px solid pink;">
                    ...
                    <div class="row">
                      <div class="col s6">
                          ...
                          <center><img src="{{URL::to('imgUniform/female-uniform-plain.jpg')}}" style="margin:20px;height:275px; width:275x; border:3px gray solid"></center>
              ...
              <div class="card grey lighten-3 z-depth-0" style="border:1px solid pink; padding:2px;">
                <div class="card-content" style="border:1px solid pink;">
                  ...
                  <div class="row">
                    <div class="col s6">
                        <a style="color:black" class="modal-trigger btn tooltipped btn-floating red" data-position="bottom" data-delay="50" data-tooltip="Click to remove order" href="#removeOrder"><i class="mdi-navigation-close"></i></a>
                        <center><img src="{{URL::to('imgUniform/female-uniform-skirt.jpg')}}" style="margin:20px;height:275px; width:275x; border:3px gray solid"></center>
                        <div class="row" style="margin-left:40px;">
                          <div class="col s3 center"><i class="small mdi-content-add-circle" style="color:teal"></i></div>
                          <div class="input-field col s6" style="margin-top:-2px;">
                            <input class="center" name="int-segment-qty[]" id="quantity" value="1" type="number">
              ...
              <div class="card grey lighten-3 z-depth-0" style="border:1px solid pink; padding:2px;">
                <div class="card-content" style="border:1px solid pink;">
                  ...
                  <div class="row">
                    <div class="col s6">
                        <a style="color:black" class="modal-trigger btn tooltipped btn-floating red" data-position="bottom" data-delay="50" data-tooltip="Click to remove order" href="#removeOrder"><i class="mdi-navigation-close"></i></a>
                        <center><img src="{{URL::to('imgUniform/male-uniform-pants-plain.jpg')}}" style="margin:20px;height:275px; width:275x; border:3px gray solid"></center>
                        <div class="row" style="margin-left:40px;">
                          <div class="col s3 center"><i class="small mdi-content-add-circle" style="color:teal"></i></div>
                          <div class="input-field col s6" style="margin-top:-2px;">
                            <input class="center" name="int-segment-qty[]" id="quantity" value="1" type="number">
  ...
  <div class="col s12" style="padding:30px">
      ...
      <a href="{{URL::to('/checkout')}}" class="right btn-flat white-text red" style="color:white; background-color:teal;">Proceed to CHECKOUT</a>
  </div>

    <div class="divider" style="margin-bottom:20px;"></div>
    <div>
      <a class="green-text" style="margin-left:20px;" href="{{URL::to('/')}}"><i style="size:20px;" class="mdi-hardware-keyboard-arrow-left"></i>CONTINUE SHOPPING</a>
    </div>
