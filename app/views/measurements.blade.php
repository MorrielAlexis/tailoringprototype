  ...
  <div class="section container white" style="width:90%; margin-top:20px; margin-bottom:20px; padding:40px;"> 
    ...
    <div class="container" style="width:90%;">
      ...
      <div class="row" style="margin-top:20px; margin-bottom:20px;">
        <div class="col s2">
          <center><img style="margin-top:10px;" class = "responsive-img" src="img/measure_exist.jpg"></center>
        </div>
        <div class="col s10">
      ...
      <div class="row" style="margin-top:20px; margin-bottom:20px;">
        <div class="col s2">
          <center><img style="margin-top:10px;" class = "responsive-img" src="img/measure_body.jpg"></center>
        </div>
        <div class="col s10">
